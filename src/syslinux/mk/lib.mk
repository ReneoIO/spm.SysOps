...
REQFLAGS  = $(GCCOPT) -D__COM32__ -D__FIRMWARE_$(FIRMWARE)__ \
...
CFLAGS  = -DPORT_PXE_HTTP=${PORT_PXE_HTTP} -DPORT_PXE_TFTP=${PORT_PXE_TFTP} \
	       $(OPTFLAGS) $(REQFLAGS) $(WARNFLAGS) $(LIBFLAGS)
